...
public:
    ...
    void  insertion(queu* point)
    {
       ...
       point->arr[point->rear]=item;
        ...
        point->fron=(point->capacity+point->fron-1)%point->capacity;
       int item;
       cout<<"enter the item"<<endl;
       cin>>item;
       point->arr[point->fron]=item;
        }
        }
        }
        }
    void deletion(queu  *point)
    {
        ...
        else
        {
                  ...
                  if(point->rear==point->fron)
            {
                ...
                {
                    cout<<"deleting element is following as"<<endl<<point->arr[point->rear]<<endl;

                    point->rear=(point->capacity+point->rear-1)%point->capacity;
                    system("pause");
            }
